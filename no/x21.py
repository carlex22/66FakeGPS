...
if os.path.exists(base_directory):
    ...
    if motoristas_ordenados:
        ...
        corrigir_login = input().upper()
        if corrigir_login == "S":
            id_primeiro_motorista_relogin = relogin[0] if relogin else None
            if id_primeiro_motorista_relogin:
                print(f"Corrigindo login do motorista {id_primeiro_motorista_relogin}...")
                # Aqui você pode adicionar a lógica para corrigir o login do motorista
            else:
                print("Não há motoristas com erro de login para corrigir.")
        else:
