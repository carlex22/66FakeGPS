...
if acao.upper() == 'A':
    ...
    pastas_arquivar = [
        ...
        ("/data/data/com.app99.driver/files/omegacache", "omegacache")
    ]
    ...
    # Move todo o conteúdo da pasta de origem de volta para as pastas originais
    ...
    # Após mover os arquivos de volta, altera as permissões para 777
