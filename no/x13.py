    ...
    if response.status_code == 200:
        ...
        if data:
            ...
            if data.get('status', '') == 2:
                ...
                saldo = "xx"
                resposta_post = f"\033[1;31mMotorista Suspenso \033[m até {expire_time_human} \nSaldo {saldo}"
                print(resposta_post)
            else:
...
# Chamar a função ticket() para extrair o ticket com o ID do motorista fornecido pelo usuário
id = input("\n\n\nDigite o número do motorista: ")
ticket_value = ticket(id)

# Chamar a função statusmotorista() com o ticket retornado pela função ticket()
if ticket_value:
    statusmotorista(ticket_value)
else:
    print("Não foi possível obter o ticket para o motorista")
