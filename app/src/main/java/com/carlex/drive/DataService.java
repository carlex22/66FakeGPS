...
public class DataService extends Service {
    ...
    public static final String PREFERENCES_FILE = "FakeSensor";
    public static final String KEY_DATA = "Ax";
    public Context context;
    private static final String TAG = "FSD";
    private static final String CHANNEL_ID = "FakeSensorServiceChannel";
    ...
    public void onCreate() {
        ...
        startForeground(1, getNotification("Fake Sensor Ligado").build());
    ...
    private  void createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            CharSequence name = "Fake sensor Service Channel";
    ...
    private  NotificationCompat.Builder getNotification(String message) {
        return new NotificationCompat.Builder(context, CHANNEL_ID)
                .setContentTitle("Fake sensor Service")
